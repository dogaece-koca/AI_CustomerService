...
def create_simulation_db():
    ...
    musteriler = [
        ...
        (9999, 'Misafir Kullanıcı', '1234567890', 'misafir@test.com', 'SMS') # 7. Niyet için mock kullanıcı
    ]
    ...
    cursor.execute('''
        CREATE TABLE sikayetler (
            ...
            tarih DATE,
            tip TEXT,                -- Yeni kolon
            takip_no TEXT,           -- Yeni kolon
            aciklama TEXT            -- Yeni kolon
        )
    ''')
    ...
    cursor.execute('''
            CREATE TABLE kampanyalar (
                id INTEGER PRIMARY KEY,
                baslik TEXT,        -- Örn: Bahar İndirimi
                detay TEXT,         -- Örn: Tüm gönderilerde %15 indirim
                aktif_mi INTEGER    -- 1: Aktif, 0: Pasif
            )
        ''')
